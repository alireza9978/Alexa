...
import ir.coleo.alexa.AlexaLib.AlexaRequest;
...
import me.coleo.mylib.models.my_pack.User;
...
//        textView.setText(alexa.invoke(a, Mode.Create).toString());
        AlexaRequest request = new AlexaRequest("http://alireza.com");

        request.sendRequest(Mode.Create, a);
